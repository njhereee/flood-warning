...
try {
    ...
    $stmtWarnings = $conn->prepare("SELECT COUNT(*) AS total_warnings FROM flood_victim WHERE status = 'warning'");
    ...
    error_log("API Error in flood_victim.php: " . $e->getMessage()); // Log error to server
